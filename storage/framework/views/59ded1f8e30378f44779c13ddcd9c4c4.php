...
<form method="POST" action="/locale" class="inline-flex items-center">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="locale" value="<?php echo e($nextLocale); ?>">
    <button
        type="submit"
        ...
        aria-label="<?php echo e(__('Switch language to')); ?> <?php echo e($nextLabel); ?>"
        title="<?php echo e(__('Switch language to')); ?> <?php echo e($nextLabel); ?>"
    >
        ...
        <span><?php echo e($nextLabel); ?></span>
    </button>
</form>
<?php /**PATH /var/www/real-estate-site/resources/views/partials/language-switcher.blade.php ENDPATH**/ ?>
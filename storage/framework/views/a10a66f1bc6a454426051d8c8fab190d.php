<?php $__env->startSection('content'); ?>
    <div class="animate-fade-up pt-6">
        <a href="<?php echo e(route('public.projects.index')); ?>" class="link-arrow mb-6 inline-flex">
        ...
        <section class="app-card space-y-5 p-6 sm:p-8">
            <div class="flex flex-wrap items-center gap-2">
                <span class="badge badge-brand"><?php echo e(__($project->status)); ?></span>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->featured): ?>
                    <span class="badge badge-violet"><?php echo e(__('★ Featured')); ?></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->published_at): ?>
                    <span class="badge badge-muted"><?php echo e(__('Published :date', ['date' => $project->published_at->format('M j, Y')])); ?></span>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>

            <div>
                <h1 class="text-3xl font-bold tracking-tight text-white sm:text-4xl"><?php echo e($project->name); ?></h1>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->description): ?>
                <p class="max-w-2xl text-sm leading-7 text-slate-400 sm:text-base"><?php echo e($project->description); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
                <div class="touch-card">
                    <p class="touch-card__label"><?php echo e(__('City')); ?></p>
                    <p class="mt-2 font-semibold text-white"><?php echo e($project->city ?? __('—')); ?></p>
                </div>
                <div class="touch-card">
                    <p class="touch-card__label"><?php echo e(__('Country')); ?></p>
                    <p class="mt-2 font-semibold text-white"><?php echo e($project->country ?? __('—')); ?></p>
                </div>
                <div class="touch-card">
                    <p class="touch-card__label"><?php echo e(__('Phases')); ?></p>
                    <p class="mt-2 font-semibold text-white"><?php echo e($project->phases->count()); ?></p>
                </div>
                <div class="touch-card">
                    <p class="touch-card__label"><?php echo e(__('Units')); ?></p>
                    <p class="mt-2 font-semibold text-white"><?php echo e($project->units_count ?? $project->units->count()); ?></p>
                </div>
            </div>

            <div class="flex flex-col gap-3 sm:flex-row">
                <a href="<?php echo e(route('installments.index', ['project_id' => $project->id])); ?>" class="app-button flex-1"><?php echo e(__('Plan a purchase')); ?></a>
                <a href="#units" class="app-button--ghost flex-1"><?php echo e(__('View units')); ?></a>
            </div>
        </section>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($galleryImages !== [] || $hasMap): ?>
            <section class="mt-9 grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.92fr)]">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($galleryImages !== []): ?>
                    <div class="app-card p-6 sm:p-8">
                        <div class="mb-5">
                            <p class="mobile-section-title"><?php echo e(__('معرض الصور')); ?></p>
                            <h2 class="mt-2 text-2xl font-bold tracking-tight text-white"><?php echo e(__('صور المشروع')); ?></h2>
                        </div>
                        <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e($img); ?>" target="_blank" class="group relative block aspect-[4/3] overflow-hidden rounded-2xl border border-white/10">
                                    <img src="<?php echo e($img); ?>" alt="<?php echo e($project->name); ?>" class="h-full w-full object-cover transition duration-500 group-hover:scale-110">
                                </a>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasMap): ?>
                    <div class="app-card space-y-4 p-6 sm:p-8">
                        <div>
                            <p class="mobile-section-title"><?php echo e(__('الموقع على الخريطة')); ?></p>
                            <h2 class="mt-1 text-2xl font-bold text-white"><?php echo e(__('موقع المشروع على خرائط جوجل')); ?></h2>
                        </div>
                        <div class="overflow-hidden rounded-2xl border border-white/10">
                            <iframe
                                src="https://www.google.com/maps?q=<?php echo e($project->map_lat); ?>,<?php echo e($project->map_lng); ?>&z=16&output=embed"
                                class="h-72 w-full"
                                loading="lazy"
                        ...
                        <a href="https://www.google.com/maps?q=<?php echo e($project->map_lat); ?>,<?php echo e($project->map_lng); ?>" target="_blank" rel="noopener noreferrer" class="link-arrow text-xs">
                            <?php echo e(__('فتح في خرائط جوجل')); ?> ←
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </section>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->buildings->isNotEmpty() || $project->units->isNotEmpty()): ?>
            ...
            <section
                ...
                x-data="{
                    buildings: <?php echo e(Js::from($buildingExplorerData)); ?>,
                    statusLabels: { available: <?php echo \Illuminate\Support\Js::from(__('Available'))->toHtml() ?>, reserved: <?php echo \Illuminate\Support\Js::from(__('Reserved'))->toHtml() ?>, sold: <?php echo \Illuminate\Support\Js::from(__('Sold'))->toHtml() ?>, hidden: <?php echo \Illuminate\Support\Js::from(__('Hidden'))->toHtml() ?> },
                    floorsLabel: <?php echo \Illuminate\Support\Js::from(__('Floors'))->toHtml() ?>,
                    floorWord: <?php echo \Illuminate\Support\Js::from(__('Floor'))->toHtml() ?>,
                    availableWord: <?php echo \Illuminate\Support\Js::from(__('available'))->toHtml() ?>,
                    m2: <?php echo \Illuminate\Support\Js::from(__('m²'))->toHtml() ?>,
                    egp: <?php echo \Illuminate\Support\Js::from(__('EGP'))->toHtml() ?>,
                    areaLabel: <?php echo \Illuminate\Support\Js::from(__('Area (m²)'))->toHtml() ?>,
                    selectedBuildingId: <?php echo e((int) ($project->buildings->first()?->id ?? 0)); ?>,
                    selectedUnit: null,
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->buildings->isNotEmpty()): ?>
            <div class="space-y-5">
                <div>
                    <p class="mobile-section-title"><?php echo e(__('Buildings & Floors')); ?></p>
                    <h2 class="mt-2 text-2xl font-bold tracking-tight text-white"><?php echo e(__('Building floor plan & availability')); ?></h2>
                    <p class="mt-2 max-w-2xl text-sm leading-6 text-slate-400"><?php echo e(__('Interactive building map')); ?> — <?php echo e(__('Explore units floor by floor and check availability at a glance.')); ?></p>
                </div>
                ...
                <div class="app-card overflow-hidden p-4 sm:p-6">
                    ...
                    <div class="mt-4 flex flex-wrap items-center gap-x-4 gap-y-2 rounded-2xl border border-white/5 bg-white/[0.03] px-4 py-2.5 text-xs text-slate-400">
                        <span class="inline-flex items-center gap-1.5"><span class="h-2.5 w-2.5 rounded-full bg-emerald-400"></span><?php echo e(__('Available')); ?></span>
                        <span class="inline-flex items-center gap-1.5"><span class="h-2.5 w-2.5 rounded-full bg-amber-400"></span><?php echo e(__('Reserved')); ?></span>
                        <span class="inline-flex items-center gap-1.5"><span class="h-2.5 w-2.5 rounded-full bg-rose-400"></span><?php echo e(__('Sold')); ?></span>
                        <span class="ms-auto inline-flex items-center gap-1.5 text-[11px] text-slate-500">
                            ...
                            <?php echo e(__('Click a unit to view its details.')); ?>
                                ...
                                <div class="flex items-stretch gap-2.5">
                                    ...
                                    <div class="flex-1 rounded-2xl border border-white/5 bg-white/[0.02] p-2">
                                        ...
                                        <div x-show="floor.units.length === 0" class="flex min-h-12 items-center justify-center rounded-xl border border-dashed border-white/10 text-xs text-slate-500">
                                            <?php echo e(__('No units on this floor')); ?>
                        ...
                        <div class="relative mt-4 overflow-hidden rounded-2xl border border-brand-500/25 bg-brand-500/[0.06] p-4">
                            <div class="flex flex-wrap items-center gap-3">
                                ...
                                <span class="ms-auto text-end">
                                    ...
                                    <span class="mt-1 block text-[10px] uppercase tracking-wide text-slate-500"><?php echo e(__('Price')); ?></span>
                                </span>
                            </div>
                            <div class="mt-3 grid gap-2 sm:grid-cols-2">
                                <a :href="selectedUnit.url" class="app-button justify-center gap-2 py-2.5 text-sm">
                                    ...
                                    <?php echo e(__('View unit details')); ?>
                                ...
                                <a :href="selectedUnit.calc_url" class="app-button--ghost justify-center gap-2 py-2.5 text-sm">
                                    ...
                                    <?php echo e(__('Calculate installment')); ?>
            ...
            <div class="space-y-5">
                <div id="units" class="rounded-2xl border border-white/10 bg-white/[0.04] p-5 sm:p-6">
                    <div class="mb-4">
                        <p class="mobile-section-title"><?php echo e(__('Selected unit preview')); ?></p>
                        <h2 class="mt-1 text-2xl font-bold tracking-tight text-white"><?php echo e(__('Selected unit preview')); ?></h2>
                        <p class="mt-1 text-sm text-slate-400"><?php echo e(__('The horizontal projection (floor plan) of the unit you choose above.')); ?></p>
                    </div>
                        ...
                        <div>
                                ...
                                <div>
                                    <template x-if="selectedUnit.floor_plan_is_image">
                                        <a :href="selectedUnit.floor_plan" target="_blank" rel="noopener noreferrer" class="group relative block overflow-hidden rounded-2xl border border-white/10 bg-slate-950/60">
                                            ...
                                            <span class="absolute bottom-2 end-2 rounded-full bg-slate-950/80 px-3 py-1 text-[11px] font-semibold text-white backdrop-blur">
                                                <span x-text="selectedUnit.number"></span> · <?php echo e(__('Floor Plan')); ?>
                                    ...
                                    <template x-if="! selectedUnit.floor_plan_is_image">
                                        <div class="flex items-center gap-3 rounded-2xl border border-white/10 bg-slate-950/60 p-4">
                                            ...
                                            <div class="min-w-0">
                                                <p class="text-sm font-semibold text-white"><span x-text="selectedUnit.number"></span> — <?php echo e(__('Floor Plan')); ?></p>
                                                <p class="text-xs text-slate-400"><?php echo e(__('Click to open the floor plan file.')); ?></p>
                                            </div>
                            ...
                            <template x-if="! selectedUnit.floor_plan">
                                <div class="flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/10 bg-white/5 py-12 text-center">
                                    ...
                                    <p class="mt-3 text-sm font-semibold text-white"><?php echo e(__('No floor plan for this unit')); ?></p>
                                    <p class="mt-1 text-xs text-slate-500"><?php echo e(__('The floor plan has not been uploaded yet.')); ?></p>
                                </div>
                            </template>
                        </div>
                    </template>
                    ...
                    <template x-if="! selectedUnit">
                        <div class="flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/10 bg-white/5 py-12 text-center">
                            <svg class="h-10 w-10 text-slate-600" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M4 4h16v16H4z" stroke-width="1.8"/><path d="M4 12h16M12 4v16M7 12v8M17 12v8" stroke-width="1.8"/></svg>
                            <p class="mt-3 text-sm font-semibold text-white"><?php echo e(__('Choose a unit to preview its floor plan')); ?></p>
                            <p class="mt-1 text-xs text-slate-500"><?php echo e(__('Select any unit from the building above.')); ?></p>
                        </div>
                    </template>
                </div>
            </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/real-estate-site/resources/views/public/projects/show.blade.php ENDPATH**/ ?>